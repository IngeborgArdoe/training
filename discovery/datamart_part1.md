...
## Exercise
In this exercise, you are going to recreate the "Yellow Trips" data mart.

To create a data mart
1. Open Genus Desktop and **Discovery**
2.  Create a new data mart by clicking **New** in the toolbar, or by right-clicking in the list of data marts and clicking **New**. 
...
Data Sources that are added more than once, represent different connections, in this case _Borough_, _Community District_ and _Taxi Zone_. For example, the two data sources for Taxi Zone represents pick up zone and drop off zone in _Yellow Trip_.  
...
To create a data mart, open Genus Desktop and **Discovery**. Create a new data mart by clicking "New" in the toolbar, or by right-clicking in the list of data marts and clicking "New". Save the data mart. 
...
1. In Genus Desktop click on Discovery -> expand Data Marts shortcut -> click on **Load Plans** -> "New"
2. "General" is a summary of **Reload** and **Auto Load** plans. 
3. In "Reload", set up the data mart to load every day at 11.00, then click Advanced... and set up reload every 12 hours for 24 hours. ![DM_loadplan.jpg](media/DM_loadplan.jpg)
4. In auto load set up to not auto load in interval 00.00-07.00 and 20.00-00.00 ![DM_loadplan_autoload.jpg](media/DM_loadplan_autoload.jpg)
